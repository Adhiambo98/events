...
if(isset($_POST['submit']))
{
    ...
    $sql="update tblcompany set companyaddress=:companyaddress,companyemail=:companyemail,regno=:regno,companyphone=:mobilenumber,companyname=:companyname, country=:country ";;
