...
(2, 'U002', 'Admin', 'adhiamboemily801@gmail.com', 'Emily', 'Adhiambo', 38001337, 'adhiambo902@gmail.com', 1, 'pro4.jpg', '21232f297a57a5a743894a0e4a801fc3', '2022-07-21 10:18:39'),
(28, 'U001', 'Admin', 'Sally', 'Sally', 'cate', 98876777478, 'sallycate67@gmail.com', 0, 'avatar15.jpg', '21232f297a57a5a743894a0e4a801fc3', '2022-07-25 19:45:45');
...
(14, 954554731, 1, 'Maxwell Lugalia', 3030303030, 'maxwellugalia66@gmail.com', '0734689874', '11 a.m', '12 p.m', 'Suyojeet Tower, near Relience Petrol Pump, Kinaara Hotel, Nashik', 'Birthday Party', 'Special Menu with Professional waiters', '2022-03-22 09:28:13', 'Done', 'Approved', '2022-03-22 09:37:17'),
(15, 977361722, 1, 'john Erick', 2021678943, 'johnerick67@gmail.com', '2022-03-24', '1 p.m', '5 p.m', 'Bansi Plaza, near Kumar Hotel, Nashik', 'Wedding', 'Special Menu', '2022-03-22 09:29:18', NULL, NULL, '2022-03-22 09:37:20');
...
ALTER TABLE `tbleventtype`  ADD `user_id` INT(11)  AFTER `CreationDate`;
